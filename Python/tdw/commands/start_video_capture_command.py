...
class StartVideoCaptureCommand(VideoCaptureCommand, ABC):
    ...
    def __init__(self, output_path: str, ffmpeg: str = "", overwrite: bool = True, framerate: int = 60, position: Dict[str, int] = None, audio: bool = True, audio_codec: str = "aac", video_codec: str = "h264", preset: str = "ultrafast", qp: int = 1, pixel_format: str = "yuv420p", log_args: bool = False, override_args: str = ""):
        ...
        """:field
        The audio codec. You should usually keep this set to the default value. See: [https://ffmpeg.org/ffmpeg-codecs.html](https://ffmpeg.org/ffmpeg-codecs.html)
        """
        self.audio_codec: str = audio_codec
        """:field
        The video codec. You should usually keep this set to the default value. See: [https://ffmpeg.org/ffmpeg-codecs.html](https://ffmpeg.org/ffmpeg-codecs.html)
        """
        self.video_codec: str = video_codec
        """:field
        H.264 video encoding only. A preset of parameters that affect encoding speed and compression. See: [https://trac.ffmpeg.org/wiki/Encode/H.264](https://trac.ffmpeg.org/wiki/Encode/H.264)
        """
