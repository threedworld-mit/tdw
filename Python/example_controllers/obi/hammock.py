...
c.communicate([{"$type": "set_obi_solver_substeps",  "solver_id": 0, "substeps": 4},
               c.get_add_material(material_name="wool_cara_black", library="materials_med.json"),
               {"$type": "set_obi_cloth_visual_material",  "id": cloth_id, "material_name": "wool_cara_black", "scale": {"x":4, "y": 4}},
