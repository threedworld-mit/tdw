...
**`self.on_send(hdri_skybox, rng, aperture, focus_distance, ambient_occlusion_intensity, ambient_occlusion_thickness_modifier, shadow_strength)`**
...
| aperture |  |  | The depth-of-field aperture. |
| focus_distance |  |  | The depth-of-field focus distance. |
| ambient_occlusion_intensity |  |  | The intensity (darkness) of the Ambient Occlusion effect. |
| ambient_occlusion_thickness_modifier |  |  | The thickness modifier for the Ambient Occlusion effect; controls "spread" of the effect out from corners. |
| shadow_strength |  |  | The shadow strength of all lights in the scene. |
