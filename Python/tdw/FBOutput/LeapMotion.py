...
class LeapMotion(object):
    ...
    # LeapMotion
    def FingerBoneAnglesAsNumpy(self):
        o = tdw.flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(10))
        if o != 0:
            return self._tab.GetVectorAsNumpy(tdw.flatbuffers.number_types.Float32Flags, o)
        return 0
    ...
    # LeapMotion
    def FingerBoneAnglesLength(self):
        o = tdw.flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(10))
        if o != 0:
            return self._tab.VectorLen(o)
        return 0
...
def LeapMotionAddFingerBoneAngles(builder, fingerBoneAngles): builder.PrependUOffsetTRelativeSlot(3, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(fingerBoneAngles), 0)
def LeapMotionStartFingerBoneAnglesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def LeapMotionAddCollisionsIds(builder, collisionsIds): builder.PrependUOffsetTRelativeSlot(4, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(collisionsIds), 0)
def LeapMotionStartCollisionsIdsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def LeapMotionAddIsCollisions(builder, isCollisions): builder.PrependUOffsetTRelativeSlot(5, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(isCollisions), 0)
