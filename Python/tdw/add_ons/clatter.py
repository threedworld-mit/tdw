...
class Clatter(AddOn):
    ...
    def __init__(self, objects: Dict[int, ClatterObject] = None, random_seed: int = None,
        ...
        :param environment: The [`ClatterObject`](../physics_audio/clatter_object.md) used for the environment (floors, walls, etc.). If None, defaults to: `ClatterObject(ImpactMaterial.wood_medium, 4, 0.5, 0.1, 100)`.
