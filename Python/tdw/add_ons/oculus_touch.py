...
class OculusTouch(VR):
    ...
    def __init__(self, human_hands: bool = True, set_graspable: bool = True, output_data: bool = True,
        ...
        :param set_graspable: If True, set all [non-kinematic objects](../../standalone/lessons/physx/physics_objects.md) and [composite sub-objects](../../standalone/lessons/composite_objects/overview.md) as graspable by the VR rig.
