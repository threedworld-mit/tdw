...
| `MIN_Y` | float | The minimum value of the y positional coordinate (the height) of a painting. | `1.1` |
...
**`Painting(wall, corner, distance, region)`**

**`Painting(wall, corner, distance, region, model=None, wall_length=None, rng=None)`**
