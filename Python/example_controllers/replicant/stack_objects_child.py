...
class StackObjects(Controller):
    ...
    MODELS: List[str] = ["b04_honey_jar_max_2014", "t-shape_wood_block", "holy_bible"]
    # The uniform scales of each model.
    #MODEL_SCALES = [2, 0.5, 2.5]
    MODEL_SCALES = [1.5, 1.0, 1.75]
    ...
    def __init__(self, port: int = 1071, check_version: bool = True, launch_build: bool = True):
        ...
        # Add a Replicant.
        self.replicant = Replicant(name="girl_casual")
        ...
        self.hold_object_position = {"x": 0.1, "y": 0.5, "z": 0.35}
    ...
    def evaluate_replicant(self) -> bool:
        ...
        # Grasp the next object.
            ...
            if self.action_ended(error_message="reset arm holding object"):
                ...
                self.replicant.move_to(target=self.stack_position, arrived_at=0.6, reset_arms=False)
