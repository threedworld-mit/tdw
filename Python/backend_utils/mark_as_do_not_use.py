...
if __name__ == "__main__":
    ...
    parser.add_argument("--reason", type=str, help="A brief reason to not use the model.", default="")
    ...
    for library in libraries:
        ...
        record.do_not_use_reason = args.reason
        lib.add_or_update_record(record, overwrite=True, write=True)

    msg = "Flagged " + args.model_name + " as do_not_use"
    if any_changes:
        print(msg)
    else:
