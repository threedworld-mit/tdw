...
class OculusTouchPyImpact(Controller):
    ...
    def trial(self) -> None:
        # Start a new trial.
        self.trial_done = False
        # Select random values for audio and visual materials
        cube_audio_material = random.choice(self.audio_materials)
        cube_visual_material = random.choice(self.visual_materials)
        cube_scrape_material = random.choice(self.scrape_materials)
        ...
        scrape_surface_model_name = random.choice(self.table_surfaces)
        ...
        self.vr.reset()
        self.vr.set_position({"x": 2.0, "y": 0.0, "z": 2.0})
        # Reset PyImpact.
