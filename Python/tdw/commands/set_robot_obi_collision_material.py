...
class SetRobotObiCollisionMaterial(RobotCommand):
    """
    Set the Obi collision material of a robot.
    """

    def __init__(self, dynamic_friction: float = 0.3, static_friction: float = 0.3, stickiness: float = 0, stick_distance: float = 0, friction_combine: MaterialCombineMode = MaterialCombineMode.average, stickiness_combine: MaterialCombineMode = MaterialCombineMode.average, id: int = 0):
        """
