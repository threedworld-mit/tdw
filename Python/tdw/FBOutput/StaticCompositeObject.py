...
def StaticCompositeObjectStart(builder): builder.StartObject(5)
def StaticCompositeObjectAddId(builder, id): builder.PrependInt32Slot(0, id, 0)
def StaticCompositeObjectAddSubObjects(builder, subObjects): builder.PrependUOffsetTRelativeSlot(1, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(subObjects), 0)
def StaticCompositeObjectStartSubObjectsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StaticCompositeObjectAddHinges(builder, hinges): builder.PrependUOffsetTRelativeSlot(2, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(hinges), 0)
def StaticCompositeObjectStartHingesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StaticCompositeObjectAddSprings(builder, springs): builder.PrependUOffsetTRelativeSlot(3, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(springs), 0)
def StaticCompositeObjectStartSpringsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StaticCompositeObjectAddMotors(builder, motors): builder.PrependUOffsetTRelativeSlot(4, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(motors), 0)
