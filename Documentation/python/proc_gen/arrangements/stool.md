...
| `OFFSET_FACTOR` | float | Offset the (x, z) positional coordinates by this factor. | `1.5` |
...
**`Stool(wall, corner, distance, region)`**

**`Stool(wall, corner, distance, region, model=None, wall_length=None, rng=None)`**
