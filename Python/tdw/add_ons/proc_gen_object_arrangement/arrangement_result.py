...
class ArrangementResult:
    """
    A description of the result of having called `ProcGenObjectArranger.get_arrangement()`.
    """
    ...
    def __init__(self, success: bool, object_ids: List[int], kinematic_object_ids: List[int], categories: List[str],
        ...
        :param categories: A list of the objects' categories. See: `ProcGenObjectArranger.MODEL_CATEGORIES`.
        ...
        """:field
        A list of the objects' categories. See: `ProcGenObjectArranger.MODEL_CATEGORIES`.
        """
