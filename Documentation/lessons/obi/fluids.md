...
Note that in this example, we've only set the *mandatory* parameters. There are many other *optional* parameters but it is much less likely that you'll want to adjust these; [Read the `Fluid` API documentation for more information.](../../python/obi_data/fluids/fluid.md)
