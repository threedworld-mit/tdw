...
#### `__init__(self, port: int = 1071, check_version: bool = True, launch_build: bool = True, udp: bool = True)`
...
| udp | If True, start a UDP heartbeat with the build. If the heartbeat stops, the controller will quit. |
