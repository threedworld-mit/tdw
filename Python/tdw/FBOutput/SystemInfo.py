...
def SystemInfoStart(builder): builder.StartObject(7)
...
def SystemInfoAddGpuId(builder, gpuId): builder.PrependInt32Slot(4, gpuId, 0)
def SystemInfoAddGpuVendorId(builder, gpuVendorId): builder.PrependInt32Slot(5, gpuVendorId, 0)
def SystemInfoAddMemory(builder, memory): builder.PrependInt32Slot(6, memory, 0)
