...
camera = ThirdPersonCamera(position={"x":-9.78, "y": 7.67, "z": 0.16},
...
chair_id1 = c.get_unique_id()
chair_id2 = c.get_unique_id()
chair_id3 = c.get_unique_id()
chair_id4 = c.get_unique_id()
...
c.communicate([{"$type": "set_screen_size",
               ...
               c.get_add_object(model_name="chair_thonet_marshall",
                                object_id=chair_id2,
                                position={"x": -5.0, "y": 0, "z": 1.85},
                                rotation={"x": 0, "y": -30, "z": 0}),
               c.get_add_object(model_name="chair_thonet_marshall",
                                object_id=chair_id3,
                                position={"x": -7.25, "y": 0, "z": 1.85},
                                rotation={"x": 0, "y": 0, "z": 0}),
               c.get_add_object(model_name="chair_billiani_doll",
                                object_id=chair_id4,
                                position={"x": -3.45, "y": 0, "z": 1.18},
