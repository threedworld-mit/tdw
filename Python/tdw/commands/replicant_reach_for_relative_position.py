...
class ReplicantReachForRelativePosition(ReplicantReachForCommand):
    """
    ...
    def __init__(self, id: int, arm: Arm, duration: float, position: Dict[str, float], max_distance: float = 1.5, arrived_at: float = 0.02, set_status: bool = True, offset: Dict[str, float] = None):
        ...
        :param position: The target position relative to the Replicant.
        ...
        """:field
        The target position relative to the Replicant.
        """
